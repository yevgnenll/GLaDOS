...
namespace GLaDOS {
    ...
    Mesh* MeshGenerator::generateTexturedCube() {
        real vertices[] = {
            ...
            -0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.25, 0.50,
            0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.50, 0.50,
            -0.5,  0.5,  0.5, 0.0, 0.0, -1.0, 0.25, 0.25,
            0.5, -0.5,  0.5, 0.0, 0.0, -1.0, 0.50, 0.50,
            0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.50, 0.25,

            //Left
            -0.5,  0.5, -0.5, 0.0, -1.0, 0.0, 0.00, 0.25,
            -0.5, -0.5, -0.5, 0.0, 0.0, 1.0, 0.00, 0.50,
            -0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.25, 0.50,
            -0.5,  0.5, -0.5, 0.0, -1.0, 0.0, 0.00, 0.25,
            -0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.25, 0.50,
            -0.5,  0.5,  0.5, 0.0, 0.0, -1.0, 0.25, 0.25,
            ...
            0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.50, 0.25,
            0.5, -0.5,  0.5, 0.0, 0.0, -1.0, 0.50, 0.50,
            0.5, -0.5, -0.5, 0.0, 1.0, 0.0, 0.75, 0.50,
            0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.50, 0.25,
            0.5, -0.5, -0.5, 0.0, 1.0, 0.0, 0.75, 0.50,
            0.5,  0.5, -0.5, -1.0, 0.0, 0.0, 0.75, 0.25,

            //Top
            -0.5,  0.5, -0.5, 0.0, -1.0, 0.0, 0.25, 0.00,
            -0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.25, 0.25,
            0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.50, 0.25,
            -0.5,  0.5, -0.5, 0.0, -1.0, 0.0, 0.25, 0.00,
            0.5,  0.5,  0.5, 0.0, -1.0, 0.0, 0.50, 0.25,
            0.5,  0.5, -0.5, -1.0, 0.0, 0.0, 0.50, 0.00,

            //Bottom
            -0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.25, 0.50,
            -0.5, -0.5, -0.5, 0.0, 0.0, 1.0, 0.25, 0.75,
            0.5, -0.5, -0.5, 0.0, 1.0, 0.0, 0.50, 0.75,
            -0.5, -0.5,  0.5, 0.0, 1.0, 0.0, 0.25, 0.50,
            0.5, -0.5, -0.5, 0.0, 1.0, 0.0, 0.50, 0.75,
            0.5, -0.5,  0.5, 0.0, 0.0, -1.0, 0.50, 0.50,
            ...
            0.5,  0.5, -0.5, -1.0, 0.0, 0.0, 0.75, 0.25,
            0.5, -0.5, -0.5, 0.0, 1.0, 0.0, 0.75, 0.50,
            -0.5, -0.5, -0.5, 0.0, 0.0, 1.0, 1.00, 0.50,
            0.5,  0.5, -0.5, -1.0, 0.0, 0.0, 0.75, 0.25,
            -0.5, -0.5, -0.5, 0.0, 0.0, 1.0, 1.00, 0.50,
            -0.5,  0.5, -0.5, 0.0, -1.0, 0.0, 1.00, 0.25
        };

        VertexBuffer* vertexBuffer = NEW_T(VertexBuffer(VertexFormatDescriptor().position().normal().texCoord0(), 36));
        vertexBuffer->copyBufferData(vertices);
