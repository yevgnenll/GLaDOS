...
namespace GLaDOS {
    ...
    class VertexBuffer : public UploadBuffer {
      public:
        ...
        Array<uint8_t, 4> getBoneIndex(std::size_t index);
        void setBoneIndex(std::size_t index, uint8_t boneIndex0, uint8_t boneIndex1, uint8_t boneIndex2, uint8_t boneIndex3);
